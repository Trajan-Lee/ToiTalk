...
<body>
    <div>
        ...
        <input type="text" id="searchInput" placeholder="Search..." onkeyup="filterBookings()">
                       ...
                       <tbody>
                           <c:forEach var="booking" items="${bookings}">
                               <tr>
								...
								<td>
									<form action="changeBookingStatusServlet" method="post"
										id="devToolChangeStatusForm-${booking.getBookingID()}"
										...
										<button type="submit" class="btn confirm">Change
											Status</button>
									</form>
								</td>
							</tr>
